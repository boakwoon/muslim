function t_forms__onReady(t) {
  ...
  fetch('<https://api.netlify.com/build_hooks/64722488ae27a50f396fe861>', {
    method: 'POST',
    body: JSON.stringify(formData), // Replace formData with your actual form data
  })
    .then(response => {
      // Handle the response from the build hook endpoint
      // This can include any success or error handling logic
    })
    .catch(error => {
  ...
  (window.t_forms__lang = (
    ...
    t_forms__onReady(function () {
      ...
      !t ||
        ((r = t.getAttribute("data-tilda-project-lang")) &&
          (window.t_forms__lang = r)),
        t_forms__initForms();
    ...
    (window.tildaForm.validate = function (t) {
          ...
          switch (d) {
            ...
            case "url":
              (c =
                ...
                _.length &&
                  ((u = (u =
                    (u = _.split("//")) && 1 < u.length ? u[1] : u[0]).split(
                    "/"
                  )) &&
                  u.length &&
                  u[0]
            ...
            case "string":
              ...
              break;
            case "chosevalue":
              "true" === s.getAttribute("data-option-selected") ||
                f.type.push("chosevalue");
              break;
            case "promocode":
              "y" !== g ||
                !y.length ||
      ...
      return (
        "y" === g &&
          ...
          (r =
            void 0 !== window.tcart_mincntorder && 0 < window.tcart_mincntorder),
          e &&
            ...
            (r = t.querySelector(".js-rule-error-" + y))
              ? (r.textContent && r.innerText) || !w || -1 !== d.indexOf(w)
                ? ((l = r.textContent || r.innerText),
                  -1 === d.indexOf(w) &&
                    (d = d + '<p class="t-form__errorbox-item">' + l + "</p>"))
        ...
        if (e[l] && e[l].obj) {
          if (0 === l && "none" === e[l].obj) {
            ...
            for (var d = 0; d < n.length; d++)
              (n[d].innerHTML = t_forms__getMsg("emptyfill")),
                (n[d].style.display = "block");
            break;
          }
          var c = e[l].obj;
          ...
          for (d = 0; d < e[l].type.length; d++) {
            ...
            if ((1, (n = t.querySelectorAll(".js-rule-error-" + u)).length))
              ...
              t_forms__getMsg(u) &&
              (n = t.querySelectorAll(".js-rule-error-all")).length
            )
            ...
            a &&
              (!s && t_forms__getMsg(u + "field")
                ? (s = t_forms__getMsg(u + "field"))
                : !s && t_forms__getMsg(u) && (s = t_forms__getMsg(u)),
              s &&
                o &&
                ((i = o.querySelectorAll(".t-input-error")),
                Array.prototype.forEach.call(i, function (t) {
            ...
            if (200 <= xhr.status && xhr.status < 400) {
              ...
              if (
                ...
                if ("{" == l.substring(0, 1)) {
                  var o = JSON.parse(l);
                  if ("object" == typeof o)
                    if (o && o.message && "OK" !== o.message)
                      t.innerHTML = o.message;
                    else if (o && o.error) {
                      var a = (s = t_forms__getErrorContainers(
                          form,
                          "Unknown error. Please, try again later."
                        )).errorBoxes,
                        n = s.allError;
              ...
              "function" == typeof window.Tilda.sendEventToStatistics
                ...
                : "" < window.mainMetrika &&
                  window[window.mainMetrika] &&
                  window[window.mainMetrika].hit(i, {
                    title: t,
                    referer: window.location.href,
                  }),
                t_triggerEvent(form, "tildaform:aftersuccess"),
              ...
              Array.prototype.forEach.call(n, function (t) {
                l
                  ? (t.innerHTML =
                      l + ". Please, try again later. [" + xhr.status + "]")
                  : xhr.statusText
                  ? (t.innerHTML =
                      "Error [" +
                      xhr.statusText +
      ...
      ((t = t.querySelectorAll(".t-input, .t-select")) &&
        ...
        Array.prototype.forEach.call(t, function (t) {
          t.addEventListener("focus", function () {
            "keyboard" === e &&
              (t.classList.contains("t-input_pvis") && (t = t.parentElement),
  ...
  function t_forms__removePlaceholder(t) {
    ...
    "INPUT" === o.tagName &&
      ...
      (t = ""),
      r
        ? (t = r.getAttribute("data-input-lid"))
        : (r = o.closest("form")) && (t = r.getAttribute("data-input-lid")),
      e &&
        t &&
        ((window.t_forms__inputData[t] = e), o.setAttribute("placeholder", "")));
  }
  function t_forms__addPlaceholder(t) {
    ...
    r
      ? (t = r.getAttribute("data-input-lid"))
      : (o = e.closest("form")) && (t = o.getAttribute("data-input-lid"));
    var o = window.t_forms__inputData[t] || "";
    o &&
      t &&
      (e.setAttribute("placeholder", o), (window.t_forms__inputData[t] = ""));
  }
    ...
    if (r) {
      ...
      if (o) {
        ...
        var a = o.getAttribute("id"),
          ...
          t = "";
        if (
          (r.tildaSendingStatus && (t = r.tildaSendingStatus),
          !((t && 1 <= t) || t_hasClass(r, "t706__submit_disable")))
        ) {
          if (
            (t_addClass(r, "t-btn_sending"),
            (r.tildaSendingStatus = "1"),
            window.tildaForm.hideErrors(o),
            (e = window.tildaForm.validate(o)),
            window.tildaForm.showErrors(o, e))
          )
            return (
          ...
          (t = document
            ...
            (e = parseInt(o.getAttribute("data-formactiontype")));
          if (
            ...
            return (
              n
                ...
                : ((i = {
                  ...
                  (n = grecaptcha.render(a + "recaptcha", i)),
                  (o.tildaCaptchaClientId = n)),
  ...
  function t_forms__submitEvent(t) {
    ...
    t.target && (r = t.target),
      r &&
        ((e = ""),
        (r = r.querySelector('[type="submit"]')) &&
          r.tildaSendingStatus &&
          (e = r.tildaSendingStatus),
        e && "3" === e
          ? (r.tildaSendingStatus = "")
  ...
  function checkVerifyTildaCaptcha(t) {
    if (
      ...
      e &&
        ((e.value = t),
        r && t_removeEl(r),
        (e = e.closest("form")) && t_forms__submitEvent(e));
    }
  }
  function t_parseScripts(n, t) {
    ...
    Array.prototype.forEach.call(t, function (t) {
      for (
        var e, r = document.createElement("script"), o = 0;
      ...
      t.innerHTML.length
        ...
        : (((e = document.createElement("script")).src = t.attributes.src.value),
          n.appendChild(e),
          t_removeEl(t));
    });
  }
  function t_forms__onSuccess(t) {
    ...
    var e = t.closest(".r"),
      ...
      l =
        t.querySelector(".t-form__successbox").getBoundingClientRect().top +
        window.pageYOffset,
      d = 0,
    ...
    121 != r ||
      ((i = t.getAttribute("data-success-callback")) &&
        (r = i.split("_onSuccess")[0].replace("t", "")));
    ...
    _ &&
      ...
      (835 != r && 862 != r) ||
        ((e = e.querySelector(".t835__btn_prev")) && (e.style.display = "none"));
  }
    ...
    for (
      ...
      if (
        !(
          !r[o].name ||
          r[o].disabled ||
          -1 < ["file", "reset", "submit", "button"].indexOf(r[o].type)
        )
      )
        if ("select-multiple" !== r[o].type)
          (-1 < ["checkbox", "radio"].indexOf(r[o].type) && !r[o].checked) ||
            e.push({ name: r[o].name, value: r[o].value });
        else
          for (var a = r[o].options, n = 0; n < a.length; n++)
            a[n].selected && e.push({ name: a[n].name, value: a[n].value });
    return e;
  }
